...
// 计算变换矩阵
vector<CImg<float> > Hough::computeTransformMatrix(CImg<float> card) {
	vector<Point> destRectPoints;
	Point tempPoint1(0, 0, 0);
	Point tempPoint2(card._width - 1, 0, 0);
	Point tempPoint3(0, card._height - 1, 0);
	Point tempPoint4(card._width - 1, card._height - 1, 0);
